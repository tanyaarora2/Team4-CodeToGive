  ...
  return (
    <div>
      ...
      <span className="profile-progress-span">
        ...
        <span><ProgressBar textarray={["A", "B", "C"]}/></span>
      </span>
      <div className="each_case_formData">
        ...
        <span className="each_case_textarea">
            ...
            <textarea value={formData.childClassification || ""} readOnly={true}/>
        </span>
        ...
        <span className="labels-span">
            ...
            <span className="each_case_textarea_label">Total Shelter Home Stay</span>
        </span>
        ...
        <span className="each_case_textarea">
            ...
            <textarea value={formData.totalShelterHomeStay || ""} readOnly={true}/>
        </span>

        <span className="labels-span">
            <span className="each_case_textarea_label">CWC Last Review</span>
            <span className="each_case_textarea_label">Last CWC Order</span>
            <span className="each_case_textarea_label">Surrender Pending Since</span>
            <span className="each_case_textarea_label">Newspaper Publication Pending Since</span>
            <span className="each_case_textarea_label">Final Police Report Pending Since</span>
        </span>

        <span className="each_case_textarea">
            <textarea value={formData.cwcLastReview || ""} readOnly={true}/>
            <textarea value={formData.lastCwcOrder || ""} readOnly={true}/>
            <textarea value={formData.surrenderPendingSince || ""} readOnly={true}/>
            <textarea value={formData.newspaperPublicationPendingSince || ""} readOnly={true}/>
            <textarea value={formData.finalPoliceReportPendingSince || ""} readOnly={true}/>
        </span>
