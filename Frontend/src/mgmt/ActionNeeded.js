  ...
  return (
    <div>
      ...
      <div className='case-id'>
        Case Id (BAD_05_2018): Name
      </div>

      <div className='action-needed-form'>
        <div className='form-section-header'>Description</div>
        <div>
        <textarea readOnly rows='5' className='desc-box'>This box will contain the description of the case as written by the social worker</textarea>
        </div>

        <div className='form-section-header'>Problem Faced</div>
        <div>
        <textarea readOnly rows='5' className='desc-box'>This box will contain the problem as written by the social worker</textarea>
        </div>
